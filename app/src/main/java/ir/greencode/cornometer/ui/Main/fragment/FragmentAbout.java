...
public class FragmentAbout extends Fragment {
    ...
    @OnClick({R.id.btn_mail, R.id.btn_linked_in, R.id.btn_git, R.id.btn_mail_hos, R.id.btn_linked_in_hos, R.id.btn_git_hos, R.id.btn_denote})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_git:
                openGit();
                break;
            case R.id.btn_mail_hos:
                sendMailForHossein();
                break;
            case R.id.btn_linked_in_hos:
                openLinkedInForHossein();
                break;
            case R.id.btn_git_hos:
                break;
